...
const LoginForm = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setError(null);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:8002")}/api/v1/auth/login`, formData);
...
_s(LoginForm, "dRglv3H9HNeKWYUcD73xsmjM/KI=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6531fc28._.js.map