...
class AuthService {
    apiUrl;
    constructor(){
        this.apiUrl = ("TURBOPACK compile-time value", "http://localhost:8002") || 'http://localhost:8002';
    }
...
const apiClient = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: ("TURBOPACK compile-time value", "http://localhost:8002") || 'http://localhost:8002',
    timeout: 10000,
    headers: {
...
"[project]/frontend/src/pages/dashboard.tsx [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/frontend/src/pages/dashboard.tsx'\n\nExpected '</', got 'className'");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__19495d86._.js.map